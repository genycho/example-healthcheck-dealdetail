 ...
 * 
 */
public class GetRecentViewContentTest extends AbstractDealSvcTestCase{
	final String apiPath = "/api/recentView/get/contents";
	final String testDealNo = DealDetailConstants.STOREDEAL_NORMAL_DEALNO;
	 public GetRecentViewContentTest() {
		 super();
	 }
	 ...
	 * */
	@Test
	public void testGetRecentViewContent_200ok() throws Exception {
