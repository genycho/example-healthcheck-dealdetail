...
import test.rest.APITestRuntimeException;
import test.rest.APITestUtils;
import test.rest.AbstractRestAPITestRunner;

/**
 * http://mediaapi.qa.tmon.co.kr/api-helper/node/apis
 */
public class AbstractMediaTestCase extends AbstractRestAPITestRunner{
		...
		public AbstractMediaTestCase() {
			...
			switch (getTestMode()) {
				...
				case AbstractRestAPITestRunner.TESTMODE_DEVSERVER:
					baseURI =  "http://mediaapi.qa.tmon.co.kr";
